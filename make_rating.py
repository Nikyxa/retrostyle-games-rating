...
df['Amount of ratings'] = (df['Amount of ratings'] - df['Amount of ratings'].min()) / (df['Amount of ratings'].max() - df['Amount of ratings'].min())

df['Rating Score'] = df['Rating'] + df['Amount of ratings'] + ((current_year - df['Date of release'].dt.year) / 100)
